  ...
  function createDomRefs() {
    ...
    return {
      ...
      els: {
        ...
        exerciseTrickQuestion: document.querySelector("#exercise-trick-question"),
        ...
        uitspelenAction: document.querySelector("#uitspelen-action"),
        uitspelenButton: document.querySelector("#uitspelen-button"),
        uitspelenUnavailable: document.querySelector("#uitspelen-unavailable"),
        uitspelenDialog: document.querySelector("#uitspelen-dialog"),
        uitspelenTitle: document.querySelector("#uitspelen-title"),
        uitspelenSummary: document.querySelector("#uitspelen-summary"),
        uitspelenClose: document.querySelector("#uitspelen-close"),
        uitspelenCancel: document.querySelector("#uitspelen-cancel"),
        uitspelenConfirm: document.querySelector("#uitspelen-confirm"),
