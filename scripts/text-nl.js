const text = {
  ...
  seedHelp: "Kopieer deze code of plak een andere herhaal-, oefenhand- of situatieseed om dezelfde kaartverdeling of spelsituatie te laden.",
  seedCopied: "Code gekopieerd.",
  seedLoaded: "Code geladen.",
  situationSeedLoaded: "Situatieseed geladen.",
  situationSeedInvalid: "Deze situatieseed kon niet worden geladen.",
  ...
  feedbackHelp: "Klik op 'kopieer feedback' en stuur een mail naar casper.peters@gmail.com. Je kunt de text in de mail plakken met ctrl+v.",
  feedbackCopied: "Feedbackrapport gekopieerd.",
  feedbackCopyFailed: "Kopieren lukte niet; probeer de tekst handmatig te selecteren.",
  feedbackMailOpening: "Mail-app wordt geopend. Gebeurt er niets? Kopieer de feedback en plak die in je mail.",
  ...
  feedbackPhase: "Fase",
  feedbackSituationSeed: "Situatieseed",
