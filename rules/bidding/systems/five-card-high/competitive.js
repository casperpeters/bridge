(function initBridgeRulesBiddingFiveCardHighCompetitive(root, factory) {
  ...
  const { fitStrength, fitValuationContext, optionalFitValuationContext, suitQuality, topHonorQuality, hasStopper } = valuationHelpers;
  ...
  function chooseOvercallFiveCardHigh(hand, auction, seat, vulnerability = "none") {
        ...
        return chooseFallbackBid([
          () => chooseProtectiveOneMajorOverMinor(shape, hand, auction, seat),
          ...
          () => chooseStrongOneMajorOvercall(shape, hand, lastBid),
  ...
  function describeCompetitiveFiveCardHighBidChoice(chosenBid, shape, hand, auction, seat, vulnerability, base) {
        ...
        if (!partnershipNonPassActions.length) {
          ...
          if (
            ...
            return fiveCardHighBidChoiceResult(chosenBid, "competitive.protectiveOneMajor", "basic", "Balance in the pass-out seat after their one-minor opening with a good five-card major and 8+ HCP.", {
              ...extra,
          ...
          if (
            ...
            return fiveCardHighBidChoiceResult(chosenBid, "competitive.strongOneMajorOvercall", "basic", "Make a natural one-level major overcall with 17-19 HCP when 1NT and a takeout double do not describe the hand.", {
              ...extra,
              minimumHcp: 17,
              maximumHcp: 19,
              suitQuality: suitQuality(hand, chosenBid.strain)
          ...
          const minimumHcp = simpleSuitOvercallMinimumHcp(shape, hand, chosenBid.strain, chosenBid.level, vulnerable);
          ...
          return fiveCardHighBidChoiceResult(chosenBid, "competitive.simpleOvercall", "basic", exceptionalSuitQuality
            ? "Make a natural vulnerable one-level overcall on 9 HCP only with exceptional top-honor suit quality."
            : `Make a natural overcall with a good five-card suit and ${minimumHcp}+ HCP.`, {
            ...extra,
            minimumHcp,
            normalMinimumHcp,
