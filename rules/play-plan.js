(function initBridgeRulesPlayPlan(root, factory) {
  ...
  const api = factory(deps.core, deps.playMechanics, deps.common, deps.notrump, deps.suitContract);
  if (isCommonJs) module.exports = api;
  root.BridgeRulesParts = root.BridgeRulesParts || {};
  root.BridgeRulesParts.playPlan = api;
})(typeof globalThis !== "undefined" ? globalThis : this, function createBridgeRulesPlayPlan(core, playMechanics, common, notrump, suitContract) {
  "use strict";
